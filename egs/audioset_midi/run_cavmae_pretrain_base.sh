...
noise=True
mixup=0.0
batch_size=48 # use 48 to avoid memory error # no MAE can handle up to 128
lr_adapt=False
...
CUDA_CACHE_DISABLE=1 python -W ignore src/run_cavmae_pretrain_piano_roll.py --model ${model} --dataset ${dataset} \
